...
from .views import home,process_photo,download_photo
...
urlpatterns = [
    ...
    path('process_photo/', process_photo, name='process_photo'),
    path('download_photo/<str:dirkey>/', download_photo, name='download_photo'),
    path('result/<slug:dirkey>', TemplateView.as_view(template_name='photo_ready.html'), name='result'),
